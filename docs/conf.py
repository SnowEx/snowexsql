#!/usr/bin/env python
#
# snowexsql documentation build configuration file, created by
...
version = snowexsql.__version__
# The full version, including alpha/beta/rc tags.
release = snowexsql.__version__
...
htmlhelp_basename = 'snowexsqldoc'
